...
public class SQSConfig {
    ...
    @Bean
    public SQSListener sqsListener(@Qualifier("listenerSqsAsyncClient")SqsAsyncClient client, SQSProperties properties, Function<Message, Mono<Void>> fn) {
