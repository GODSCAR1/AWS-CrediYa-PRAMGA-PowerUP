    ...
    public SecurityWebFilterChain securityWebFilterChain(ServerHttpSecurity http,
        ...
        return http
                ...
                .authorizeExchange(auth -> auth
                        // públicos reales
                        .pathMatchers("/actuator/health", "/public/**","/reportes/swagger-ui/**",
                                "/reportes/v3/api-docs/**", "/actuator/health", "/actuator/health/**").permitAll()
                        .pathMatchers(HttpMethod.GET,"/api/v1/reporte").hasRole("ADMIN")
